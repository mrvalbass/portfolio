...
export default function Project({
  ...
  return (
    ...
    >
      <div className="absolute z-10 bg-black/60 rounded-xl h-full w-full flex flex-col gap-5 justify-center items-center md:opacity-0 md:hover:opacity-100 duration-200">
